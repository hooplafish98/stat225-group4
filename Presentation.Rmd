...
#boot3 = plot(results, index=3) # BLK
...
kde3 = ggplot(data = nbaper36select, aes(BLK)) +
  geom_density(bw = "SJ", kernel = "epanechnikov", size = 2)
...
MP = 9.499 - 0.333 TRB - 0.589 BLK + 0.669 TOV
- 0.330 FTA + 0.879 PTS + 5.492 FG
...
MP = 9.710 - 0.366 TRB - 0.539 BLK + 0.677 TOV
- 0.326 FTA + 0.903 PTS + 5.823 FG
