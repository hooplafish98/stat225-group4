...
tableols = summary(ols_mod)$coefficients [,4]

kable(round(tableols,4))%>% kable_styling(position = "center")
...
tableols_r = summary(ols_mod1)$coefficients [,4]

kable(round(tableols_r,4))%>% kable_styling(position = "center")
``` 
...
tablejhm= summary(model_f)$coefficients [,4]

kable(round(tablejhm,4))%>% kable_styling(position = "center")
...
tablejhm_r= summary(model_f1)$coefficients [,4]

kable(round(tablejhm_r,4))%>% kable_styling(position = "center")
```

MP = 9.4239 - 1.2996 AST + 1.2995 TOV
0.9083 PTS 
...
mplot(model_f1, which = c(1))
mplot(full_gam1, which = c(1))
